    ...
    return (
      <div className='max-w-4xl mx-auto px-8 py-20 text-center'>
        ...
        <p className='text-slate-500 mb-6'>
          Товар с таким ID не существует или был удалён.
        </p>
          ...
          <div className='lg:col-span-3'>
            ...
            <div className='bg-slate-50 rounded-xl p-5 mb-6'>
              {product.priceHidden ? (
                <div className='text-center py-4'>
                  <div className='text-lg font-semibold text-slate-500 mb-1'>
                    🔒 Цена скрыта
                  </div>
                  <p className='text-sm text-slate-400'>
                    Поставщик публикует цену только для зарегистрированных
                    покупателей. Добавьте товар в заявку, чтобы узнать
                    стоимость.
                  </p>
                </div>
              ) : (
                <div className='flex items-end gap-4'>
                  ...
                  {product.priceDiscount && (
                    <span className='bg-red-50 text-red-600 text-xs font-semibold px-2.5 py-1 rounded-full mb-1'>
                      -
                      {Math.round(
                        (1 - product.priceDiscount / product.price) * 100,
                      )}
                      %
                    </span>
                  )}
            ...
            <div className='grid grid-cols-2 gap-3 mb-6'>
              ...
              <div className='bg-white border border-slate-200 rounded-xl p-4'>
                ...
                <div
                  className={`font-semibold ${product.inStock ? "text-emerald-600" : "text-red-500"}`}>
                  {product.inStock
            ...
            <button
              ...
              {isInRequest
                ? "✓ Товар в заявке (нажмите, чтобы убрать)"
                : "+ Добавить в заявку"}
            </button>
          </div>
        </div>
